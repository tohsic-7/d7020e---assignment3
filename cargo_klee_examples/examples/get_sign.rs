...
// [your answer here]
/* 
    cargo_klee_examples/target/debug/examples/klee-last/ 
*/
//
// B) Replay test cases
//
...
//
// [your answer here]
// the program triggers the path where it returns 1
//
...
// [your answer here]
/* 
    Since I have not used either very much it is a bot hard to rate them.
    But both give good infromation about the execution of the program 
    but could benefit from easier installation therefore 4/5.
*/
//
...
// [your answer here]
/* 
    It finds the latest modefied .ll file in the for-loop starting at line 211
    by comparing SystemTime.
*/
//
